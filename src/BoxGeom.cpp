...
BoxGeom::BoxGeom(dSpaceID space, dReal lx, dReal ly, dReal lz)
{
    // create the geom
...
void BoxGeom::Draw()
{
    ...
    if (gDrawGeomsFlag)
    {
        ...
        const dReal *boxRelPosition = dGeomGetOffsetPosition(m_GeomID);
        const dReal *boxRelRotation = dGeomGetOffsetRotation(m_GeomID);
